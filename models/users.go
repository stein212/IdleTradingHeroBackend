...
type User struct {
	...
	TelegramId null.Int  `boil:"telegramId" json:"telegramId,omitempty" toml:"telegramId" yaml:"telegramId,omitempty"`
	CreatedOn  time.Time `boil:"createdOn" json:"createdOn" toml:"createdOn" yaml:"createdOn"`
...
var UserWhere = struct {
	...
	TelegramId: whereHelpernull_Int{field: "\"users\".\"telegramId\""},
	CreatedOn:  whereHelpertime_Time{field: "\"users\".\"createdOn\""},
}
...
var (
	userAllColumns            = []string{"id", "username", "password", "email", "firstName", "lastName", "telegramId", "createdOn"}
	userColumnsWithoutDefault = []string{"id", "username", "password", "email", "firstName", "lastName", "telegramId", "createdOn"}
